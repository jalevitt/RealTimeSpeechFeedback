...
This is a script I wrote to help evaluate the formant and f0 detection vs PRAAT.
You need to give it the path to a .txt files generated by PRAAT for f0 and formants, and 
the script will compare those values to the values from our algorithms
"""
import numpy as np
import scipy as sp
...
def getYinPitchAtTime(Recording, fs, Time):
    ...
    f0 = yin.getPitch(cmndf, fs/500, fs/75, harmo_th = 0.35, method = 'yin')
    return f0    
